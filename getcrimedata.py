...
for i in unique_locations:
    ...
    json_to_df(results.json(), cur, i[2], month)



# Build a summary table
summary_query = "select count(lng) as count, crime_type, street from crime group by crime_type, street"
...
# This is a work in progress attempt to create a series of increasingly small
# bounding boxes (polygons for GET or POST requests) to avoid a 503 error (too much data)
# Idea is to split each box if too much data then try again on resulting output
# class BoundingBox:
